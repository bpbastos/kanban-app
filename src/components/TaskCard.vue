<template>
  <article class="flex flex-col rounded-lg bg-white drop-shadow-xl p-2 space-y-2 cursor-pointer">
    <div class="flex justify-between">
      <span class="block w-24 rounded  p-1 text-center text-xs font-light text-white opacity-80" :class="priorityColor">
        {{ priorityLabel }}
      </span>
      <div class="text-red-400 hover:text-red-700 cursor-not-allowed text-xs w-2/2"
         @click="deleteTask">
  ...
  <DeleteConfirmationModal  show-modal="show" />
</template>
