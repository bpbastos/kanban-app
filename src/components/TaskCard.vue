<template>
  <article class="flex flex-col space-y-5 rounded-lg bg-white p-3 drop-shadow-xl">
    <div class="flex justify-between">
      ...
      <div class="text-red-400 hover:text-red-700 cursor-pointer text-xs" @click="emit('delete', id)">
    ...
    <div class="flex flex-row space-x-1 items-center text-xs">
      <div class="bg-blue-100 flex rounded-3xl px-1 sm:px-1.5 py-0.5 text-blue-900 mr-1"><svg class="fill-current"
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="19">
          <path fill="none" d="M0 0h24v24H0z"></path>
          <path
